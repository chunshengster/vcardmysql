...
//	private $_status = 'new';
    ...
    public function store_vCard_Geographical_Properties() {
        $this->_get_storage_resource();
        $this->obj_vcard_storage->store_data('vCard_Geographical_Properties', $this->vCard_Geographical_Properties);
    }

    public function store_vCard_Organizational_Properties() {
        $this->_get_storage_resource();
        $this->obj_vcard_storage->store_data('vCard_Organizational_Properties', $this->vCard_Organizational_Properties);
    }

    public function store_vCard_Telecommunications_Addressing_Properties_Email() {
        $this->_get_storage_resource();
        $this->obj_vcard_storage->store_data('vCard_Telecommunications_Addressing_Properties_Email', $this->vCard_Telecommunications_Addressing_Properties_Email);
    }

    public function store_vCard_Telecommunications_Addressing_Properties_Tel() {
        $this->_get_storage_resource();
        $this->obj_vcard_storage->store_data('vCard_Telecommunications_Addressing_Properties_Tel', $this->vCard_Telecommunications_Addressing_Properties_Tel);
    }
